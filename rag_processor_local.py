...
class HeuristicProcessor:
    ...
    def __init__(self):
        ...
        # ⚡ BOLT OPTIMIZATION: Disable unused spaCy pipeline components for performance and memory footprint improvement
        # Use a lightweight "sentencizer" instead of the full "parser" to keep sentence segmentation working.
