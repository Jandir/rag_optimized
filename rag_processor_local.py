...
class HeuristicProcessor:
    ...
    def __init__(self):
        ...
        # ⚡ BOLT OPTIMIZATION: Disable unused spaCy pipeline components for faster initialization and lower memory usage
        # We only need NER (for entities) and Sentencizer (for segmenting text)
