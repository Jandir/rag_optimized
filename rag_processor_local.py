...
def extract_metadata_from_filename(filename_str: str) -> Dict[str, str]:
    ...
    suffix_txt_trans = " Transcrição.txt"
    suffix_txt = ".txt"
    suffix_srt_trans = " Transcrição.srt"
    suffix_srt = ".srt"

    if filename_str.endswith(suffix_txt_trans):
        clean_name_str: str = filename_str[:-len(suffix_txt_trans)]
    elif filename_str.endswith(suffix_txt):
        clean_name_str = filename_str[:-len(suffix_txt)]
    elif filename_str.endswith(suffix_srt_trans):
        clean_name_str = filename_str[:-len(suffix_srt_trans)]
    elif filename_str.endswith(suffix_srt):
        clean_name_str = filename_str[:-len(suffix_srt)]
    else:
