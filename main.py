...
def extract_metadata_from_filename(filename: str) -> Dict[str, str]:
    ...
    suffix1 = " Transcrição.txt"
    suffix2 = ".txt"
    if clean_name.endswith(suffix1):
        clean_name = clean_name[:-len(suffix1)]
    elif clean_name.endswith(suffix2):
        clean_name = clean_name[:-len(suffix2)]
